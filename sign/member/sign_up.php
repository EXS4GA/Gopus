...
<html lang="en">
  ...
  <select class="form-select" id="inputGroupSelect01" name="jurusan">
    <option selected>Choose</option>
    <option value="Teknik Konstruksi Perumahan">Teknik Jaringan Komputer dan Telekomunikasi</option>
    <option value="Teknik Tenaga Listrik">Manajemen Perkantoran dan Layanan Bisnis</option>
    <option value="Teknik Instalasi Tenaga Listrik">Akomodasi Perhotelan</option>
    <option value="Teknik Komputer Jaringan">Pemasaran</option>
    </select>
  </div>
