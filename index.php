  ...
  <div class="container-fluid">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">Golden</span>Perpus</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">Golden Perpus</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        ...
        <div class="card-body">
          <h5 class="card-title">Student At SMK Golden</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        <div class="col mt-3">
          <h3 class="text-light fs-5">Email : attallahdaska@gmail.com</h3>
          <h3 class="text-light fs-5">Instagram : attallahdaska</h3>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">TIM DASKA</a>  2024</p>
        </div>
      </div>
    </footer>
