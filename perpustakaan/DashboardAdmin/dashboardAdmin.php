...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid p-3">
        ...
        <div class="dropdown">
          <button class="btn btn-light dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="../assets/profile pic.jpg" alt="adminLogo" width="40px">
          </button>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span> di Dashboard GoldenPerpus</div>
      ...
      <div class="mt-4 p-3">
        ...
        <div class="cardImg">
          <a href="member/member.php">
            <img src="../assets/dashboardCardMember/member12.png" alt="daftar buku" style="max-width: 100%;" width="600px">
          </a>
        </div>
        <div class="cardImg">
          <a href="buku/daftarBuku.php">
          <img src="../assets/dashboardCardMember/daftarBukucoy.png" alt="daftar buku" style="max-width: 100%;" width="600px">
          </a>
        </div>
